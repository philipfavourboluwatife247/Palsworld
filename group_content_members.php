<div style="min-height: 400px;width:100%;background-color: white;text-align: center;">
	...
	<?php if(group_access($_SESSION['palsworld_userid'],$group_data,'member')):?>
	<?php
		...
		if(isset($_GET['remove_comfirmed']) && (group_access($_SESSION['palsworld_userid'],$group_data,'admin'))){
			...
			<a href="'.ROOT.'group/'.$group_data['userid'].'/members">
				<input id="post-button" type="button" value="Back" style="font-size:11px;margin-right:10px;background-color: #1b9186;width:auto;">
			</a>
			';
		}else
		if(isset($_GET['edit_access']) && (group_access($_SESSION['palsworld_userid'],$group_data,'admin'))){
			...
			if(isset($_POST['role']) && isset($_POST['userid'])){
				...
				<br>
	 			...
	 			<input id="post-button" type="submit" value="Save" style="font-size:11px;margin-right:10px;background-color: #91261b;width:auto;">
	 			<a href="'.ROOT.'group/'.$group_data['userid'].'/members">
					<input id="post-_button" type="button" value="Cancel" style="float:left;font-size:11px;margin-right:10px;background-color: #1b9186;width:auto;">
				</a>
				</form>
				';
 
		}else
		if(isset($_GET['remove']) && (group_access($_SESSION['palsworld_userid'],$group_data,'admin'))){
			...
			<a href="'.ROOT.'group/'.$group_data['userid'].'/members?remove_comfirmed='.$FRIEND_ROW['userid'].'">
				<input id="post-button" type="button" value="Remove" style="font-size:11px;margin-right:10px;background-color: #91261b;width:auto;">
			</a>
			<a href="'.ROOT.'group/'.$group_data['userid'].'/members">
				<input id="post-button" type="button" value="Cancel" style="float:left;font-size:11px;margin-right:10px;background-color: #1b9186;width:auto;">
			</a>
			';
