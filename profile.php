<?php
	...
	$login = new Login();
	$_SESSION['palsworld_userid'] = isset($_SESSION['palsworld_userid']) ? $_SESSION['palsworld_userid'] : 0;
	
	$user_data = $login->check_login($_SESSION['palsworld_userid'],false);
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(isset($_POST['username'])){
			...
			$settings_class->save_settings($_POST,$_SESSION['palsworld_userid']);
  ...
  margin-bottom: 20px;
	...
	<body style="font-family: tahoma;  background-color: #bcb3d0;">
 			...
 			<div style="max-width:600px;margin:auto;min-height: 400px;flex:2.5;padding: 20px;padding-right: 0px;">
 					...
 					<form method="post" action="<?=ROOT?>profile/profile" enctype="multipart/form-data">
	 					<div style="border:solid thin #aaa; padding: 10px;background-color: white;">
	 						...
	 						<input id="post-button" type="submit" style="width:120px;" value="Change">
	 						<br>
		...
		<div style="width: 800px;margin:auto;min-height: 400px;">
			...
			<div style="background-color:#c9c7ce;text-align: center;color: #405d9b">
				...
				<span style="font-size: 12px;">
					...
					<img style="width: 150px;margin-top: -200px;border-radius: 50%;border: 2px solid #fff;" src="<?php echo ROOT . $image ?>"><br/>
				...
				<br>
					<div style="font-size: 20px;color: black;">
						...
						<a href="<?=ROOT?>like/user/<?php echo $user_data['userid'] ?>">
							<input id="post-button" type="button" value="Follow <?php echo $mylikes ?>" style="margin-right:10px;background-color: #9b409a;width:auto;">
						</a>

						<?php if($user_data['userid'] == $_SESSION['palsworld_userid']): ?>
							<a href="<?=ROOT?>messages">
								<input id="post-button" type="button" value="Messages" style="margin-right:10px;background-color: #1b9186;width:auto;">
							</a>
						<?php else: ?>
							<a href="<?=ROOT?>messages/new/<?=$user_data['userid']?>">
								<input id="post-button" type="button" value="Message" style="margin-right:10px;background-color: #1b9186;width:auto;">
							</a>
						<?php endif; ?>
				...
				<a href="<?=ROOT?>home"><div id="menu-buttons">Timeline</div></a>
				<a href="<?=ROOT?>profile/<?php echo $user_data['userid'] ?>/about"><div id="menu-buttons">About</div></a>
				<a href="<?=ROOT?>profile/<?php echo $user_data['userid'] ?>/followers"><div id="menu-buttons">Followers</div></a>
				<a href="<?=ROOT?>profile/<?php echo $user_data['userid'] ?>/following"><div id="menu-buttons">Following</div></a>
				<a href="<?=ROOT?>profile/<?php echo $user_data['userid'] ?>/photos"><div id="menu-buttons">Photos</div></a>
				
				<?php 
					if($user_data['userid'] == $_SESSION['palsworld_userid']){
						
						echo '<a href="'.ROOT. 'profile/'.$user_data['userid'].'/groups"><div id="menu-buttons">Groups</div></a>';
						echo '<a href="'.ROOT. 'profile/'.$user_data['userid'].'/settings"><div id="menu-buttons">Settings</div></a>';
					}
				?>
			</div>
