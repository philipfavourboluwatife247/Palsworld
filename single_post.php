...
<!DOCTYPE html>
	<html>
	<head>
		<title>Single Post | Palsworld</title>
	</head>
	...
	<body style="font-family: tahoma; background-color: #bcb3d0;">
		...
		<!--post area-->
	<?php if(!($is_group_post && $group_data['group_type'] == 'private' && !group_access($_SESSION['palsworld_userid'],$group_data,'member'))): ?>
 				...
 				<div style="min-height: 400px;flex:2.5;padding: 20px;padding-right: 0px;">
 					...
 					<div style="border:solid thin #aaa; padding: 10px;background-color: white;">
  					 ...
  					 <?php if($ROW['parent'] == 0): ?>
						...
						<?php if(!($is_group_post && $group_data['group_type'] == 'public' && !group_access($_SESSION['palsworld_userid'],$group_data,'member'))): ?>
 					 ...
 					 <?php else: ?>
 					 	<a href="<?=ROOT?>single_post/<?php echo $ROW['parent'] ?>" >
 					 		<input id="post-button" style="width:auto;float: left;cursor: pointer;" type="button" value="Back to main post" />
 					 	</a>
 					 <?php endif; ?>
 						...
 						<?php if($ROW['parent'] == 0): ?>
	 						...
	 						<a href="<?= $pg['next_page'] ?>">
		 					 <input id="post-button" type="button" value="Next Page" style="float: right;width:150px;">
		 					 </a>
		 					 <a href="<?= $pg['prev_page'] ?>">
		 					 <input id="post-button" type="button" value="Prev Page" style="float: left;width:150px;">
		 					 </a>
